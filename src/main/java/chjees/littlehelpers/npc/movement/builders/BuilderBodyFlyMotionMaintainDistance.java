package chjees.littlehelpers.npc.movement.builders;

import chjees.littlehelpers.npc.movement.BodyFlyMotionMaintainDistance;
...
public class BuilderBodyFlyMotionMaintainDistance  extends BuilderBodyMotionBase {
    ...
    public BuilderBodyFlyMotionMaintainDistance() {
    }

    @Nonnull
    public BodyFlyMotionMaintainDistance build(@Nonnull BuilderSupport builderSupport) {
        return new BodyFlyMotionMaintainDistance(this, builderSupport);
    }

    @Nonnull
    @Override
    public String getShortDescription() {
        return "Maintain distance from a given position for fliers";
    }
    ...
    @Nonnull
    public BuilderBodyFlyMotionMaintainDistance readConfig(@Nonnull JsonElement data) {
