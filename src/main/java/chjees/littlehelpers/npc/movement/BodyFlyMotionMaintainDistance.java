package chjees.littlehelpers.npc.movement;
...
public class BodyFlyMotionMaintainDistance  extends BodyMotionBase {
    ...
    public BodyFlyMotionMaintainDistance(@Nonnull BuilderBodyFlyMotionMaintainDistance builder, @Nonnull BuilderSupport support) {
        super(builder);
    ...
    public boolean computeSteering(
        ...
        if (!support.getActiveMotionController().matchesType(MotionControllerFly.class)) {
            ...
            @SuppressWarnings("DataFlowIssue") NPCEntity npcComponent = componentAccessor.getComponent(ref, NPCEntity.getComponentType());
